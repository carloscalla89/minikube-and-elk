...
DB_NAME=${1:-"mitocodedb"}       # Valor por defecto: dragonballdb
DB_USER=${2:-"mitocodequarkusdbuser"}            # Valor por defecto: user_db
DB_PASS=${3:-"Java360445"}    # Valor por defecto: password_secure
